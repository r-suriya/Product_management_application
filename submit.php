...
function search(&$pid, &$pname, &$pvalue, $pid_search)
{
    ...
    //display
    echo "<table><tr><th>PID</th><th>PName</th><th>PValue</th>";
    echo "<tr><td>" . $pid[$pid_search - 1] . ".</td>" . "<td>" . $pname[$pid_search - 1] . "</td>" . "<td>" . $pvalue[$pid_search - 1] . "</td></tr>";
...
function display(&$pid, &$pname, &$pvalue)
{
    ...
    for ($i = 0; $i < count($pid); $i++) {
        echo "<tr><td>" . $pid[$i] . ".</td>" . "<td>" . $pname[$i] . "</td>" . "<td>" . $pvalue[$i] . "</td></tr>";
    }
    echo "</table>";
}
?>